...
var FhirHttpService = /** @class */ (function (_super) {
    ...
    FhirHttpService.prototype.getEncountersForPatient = function (dateRange) {
        ...
        return Promise.resolve([new _fhir_data_classes_encounter__WEBPACK_IMPORTED_MODULE_6__["Encounter"]({
                'resourceType': 'Bundle',
                'id': 'f22d19cc-1b76-4171-bbbd-5436496bf28b',
                'type': 'searchset',
                'total': 4,
                ...
                'entry': [
                    {
                        ...
                        'resource': {
                            ...
                            'participant': [
                                {
                                    'individual': { 'display': 'Who, Doctor', 'reference': 'Practitioner/1' },
                    ...
                    },
                    {
                        ...
                        'resource': {
                            ...
                            'patient': { 'display': 'Smart, Joe', 'reference': 'Patient/4342010' },
                            'period': {
                                'start': '2018-11-01T06:00:00.000Z',
                                'end': '2018-11-10T06:00:00.000Z'
                            },
                            'resourceType': 'Encounter',
                            'serviceProvider': { 'reference': 'Organization/619848' },
                            'status': 'finished',
...
var APP_TIMESPAN = luxon__WEBPACK_IMPORTED_MODULE_0__["Interval"].fromDateTimes(luxon__WEBPACK_IMPORTED_MODULE_0__["DateTime"].utc().minus(luxon__WEBPACK_IMPORTED_MODULE_0__["Duration"].fromObject({ months: 18 })), luxon__WEBPACK_IMPORTED_MODULE_0__["DateTime"].utc());
