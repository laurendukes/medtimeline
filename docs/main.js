...
/* harmony import */ var _smart_on_fhir_client__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./smart-on-fhir-client */ "./src/app/smart-on-fhir-client.ts");
// Copyright 2018 Verily Life Sciences Inc.
//
// Use of this source code is governed by a BSD-style
// license that can be found in the LICENSE file.
...
var FhirHttpService = /** @class */ (function (_super) {
    ...
    FhirHttpService.prototype.getObservationsWithCode = function (code, dateRange, limitCount) {
        ...
        return this.smartApiPromise.then(function (smartApi) {
            return smartApi.patient.api.fetchAll(queryParams)
                ...
                return results
                    .map(function (result) {
                    return new _fhir_data_classes_observation__WEBPACK_IMPORTED_MODULE_8__["Observation"](result);
                })
                    // TODO(b/126775896): Determine which statuses to
                    // filter out.
                    .filter(function (result) { return result.status !==
                    _fhir_data_classes_observation__WEBPACK_IMPORTED_MODULE_8__["ObservationStatus"].EnteredInError; });
            }, 
    ...
    FhirHttpService.prototype.getMedicationOrderWithId = function (id) {
        ...
        return this.smartApiPromise.then(function (smartApi) {
            return smartApi.patient.api
                ...
                .then(function (result) {
                return new _fhir_data_classes_medication_order__WEBPACK_IMPORTED_MODULE_7__["MedicationOrder"](result.data);
            }, 
    ...
    FhirHttpService.prototype.getMedicationAdministrationsWithOrder = function (id) {
        ...
        return this.smartApiPromise.then(function (smartApi) { return smartApi.patient.api.fetchAll(queryParams)
            ...
            results.map(function (result) {
                return new _fhir_data_classes_medication_administration__WEBPACK_IMPORTED_MODULE_6__["MedicationAdministration"](result);
            });
        }, 
        // Do not return any MedicationOrders for
        // this code if one of the MedicationOrder
    ...
    FhirHttpService = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Injectable"])(),
        __param(1, Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Inject"])(_smart_on_fhir_client__WEBPACK_IMPORTED_MODULE_10__["SMART_ON_FHIR_CLIENT"])),
...
const dev = {
  ...
  credentials: {
    client_id: '96cf3520-c11a-4bfc-9e50-8ff8fd4ff668',
  },
  url: {
    host: '',
...
const prod = {
  ...
  credentials: {
    client_id: '7740ee16-151f-4a1d-9a5d-4b5bbe071f97',
  },
  url: {
    host: '',
    redirectURL: 'https://laurendukes.github.io/medtimeline/',
    launchURL: 'https://laurendukes.github.io/medtimeline/auth'
  },
  auth: {
    username: 'portal',
    password: 'portal',
...
module.exports = __webpack_require__(/*! /usr/local/google/home/laurendukes/bch_lcd/medtimeline/medtimeline/src/main.ts */"./src/main.ts");
