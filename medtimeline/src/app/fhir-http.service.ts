  ...
  getEncountersForPatient(dateRange: Interval): Promise<Encounter[]> {
    ...
    return Promise.resolve([new Encounter({
      ...
      'entry': [
        {
          'fullUrl':
              'https://fhir-open.sandboxcerner.com/dstu2/0b8a0111-e8e6-4c26-a91c-5069cbc6b1ca/Encounter/4027918',
          'resource': {
            'class': 'inpatient',
            'id': '4027918',
            'identifier': [{
            ...
            'location': [{
              'location': {
                'display':
                    'Baseline East Medical Center, BE Hospital, 1N, 0152, A',
                'reference': 'Location/35646785'
              },
              'status': 'completed'
            }],
            'meta':
                {'lastUpdated': '2016-06-27T15:01:18.000Z', 'versionId': '1'},
            'participant': [
              {
                'individual':
            ...
            'patient':
                {'display': 'Smart, Joe', 'reference': 'Patient/4342010'},
            'period': {
